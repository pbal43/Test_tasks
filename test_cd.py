# Файл должен лежать в основной рабочей директории
    ...
    if nome == 0:
        ...
        if nnn == bb:
            with open(results, 'a') as nome_rep:
                nome_rep.write('10. Успех. Отображение имени текущего каталога успешно\n')
            break
    else:
        with open(results, 'a') as nome_rep:
            nome_rep.write('10. Баг! тображение имени текущего каталога некорректно / не осуществлено!\n')
        break
