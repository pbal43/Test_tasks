...
while True:
    ...
    if m_lf_w == 0:
        ...
        break
# 17. Переход на другой диск с использованием обратных слешей
while True:
    ...
    if m_od_rev == 0:
        with open(results, 'a') as m_od_rev_rep:
            m_od_rev_rep.write('17. Успех. Переход на другой диск с использованием обратных слешей в пути успешен\n')
        break
    else:
        with open(results, 'a') as m_od_rev_rep:
            m_od_rev_rep.write('17. Баг! Переход на другой диск с использованием обратных слешей в пути не осуществлен!\n')
        break
...
while True:
    ...
    if m_r_p2 == 0:
        with open(results, 'a') as m_r_p2_rep:
            m_r_p2_rep.write('18. Успех. Переход во вложенный каталог на 1 уровень успешен с указанием полного пути и двойных слешей\n')
        break
    else:
        with open(results, 'a') as m_r_p2_rep:
            m_r_p2_rep.write('18. Баг! Переход во вложенный каталог на 1 уровень не осуществлен с указанием полного пути и двойных слешей!\n')
        break
...
while True:
    ...
    if m_r_pk == 0:
        ...
        break
# 22. Переход в директорию, содержащую имя на латиннице в разных регистрах с несоблюдением регистра:
while True:
    ...
    if m_r_preg == 0:
        with open(results, 'a') as m_r_preg_rep:
            m_r_preg_rep.write('22. Успех. Переход в директорию, содержащую имя на латиннице в разных регистрах с несоблюдением регистра успешен\n')
        break
    else:
        with open(results, 'a') as m_r_preg_rep:
            m_r_preg_rep.write('22. Баг! Переход в директорию, содержащую имя на латиннице в разных регистрах с несоблюдением регистра не осуществлен!\n')
        break
# 23. Переход в директорию, содержащую имя на латиннице, кириллице, цифры, иные символы:
while True:
    ...
    if m_r_poth == 0:
        with open(results, 'a') as m_r_poth_rep:
            m_r_poth_rep.write('23. Успех. Переход в директорию, содержащую имя на латиннице, кириллице, цифры, иные символы, успешен\n')
        break
    else:
        with open(results, 'a') as m_r_poth_rep:
            m_r_poth_rep.write('23. Баг! Переход в директорию, содержащую имя на латиннице, кириллице, цифры, иные символы, не осуществлен!\n')
        break
